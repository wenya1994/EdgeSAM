...
os.environ['MASTER_ADDR'] = 'localhost'  # 我加的
os.environ['MASTER_PORT'] = '0123'  # 我加的

torch.distributed.init_process_group(backend='gloo', init_method='env://', rank=0, world_size=1)  # 我加的
# torch.distributed.init_process_group(backend='nccl', init_method='env://', rank=0, world_size=1)  # 我加的
...
def make_data_loader(spec, tag=''):
    ...
    loader = DataLoader(dataset, batch_size=spec['batch_size'],
                        shuffle=False, num_workers=0, pin_memory=True, sampler=sampler)
    return loader
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--config', default="configs/train/setr/train_setr_evp_cod.yaml") # 原
    parser.add_argument('--config', default="configs/cod-sam-vit-b.yaml")  # 改
