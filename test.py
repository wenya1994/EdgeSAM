...
def eval_psnr(loader, model, data_norm=None, eval_type=None, eval_bsize=None,
    ...
    for batch in pbar:
        ...
        # [1,1,1024,1024]
        prediction = np.array(transforms.Resize((h, w))(to_pil(pred.data.squeeze(0).cpu())))
        save_dir = os.path.join("results", str(tem_name) + ".jpg")
...
if __name__ == '__main__':
 ...
 # python test.py --config "./configs/cod-sam-vit-b.yaml" --model "./save/_cod-sam-vit-b/model_epoch_last.pth"
